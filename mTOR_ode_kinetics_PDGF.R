...
L0 <- 1 # choose 1; 0.3; 0.1; 0.03 nM of PDGF for Fig. S2B
...
#Fig. S2B
x_PDGF <- c(0,5,15,30,60,120) 
y_PDGF_003 <- c(0.028,0.022,0.023,0.017,0.011,0.0053) # PDGF0=0.03 nM
y_PDGF_01 <- c(0.101,0.116,0.106,0.085,0.058,0.023) # PDGF0=0.1 nM
y_PDGF_03 <- c(0.32,0.34,0.31,0.26,0.21,0.13) # PDGF0=0.3 nM
y_PDGF_1 <- c(0.92,0.85,0.98,0.8,0.72,0.51) # PDGF0=1 nM
plot(out[,1],out[,28], col="grey70",lwd = 2,lty="solid", ylab='PDGF, nM', xlab='time, min',type = "l", ylim=c(0, 1)) # L0=1
lines(out[,1],out[,28], col="grey50",lwd = 2,lty="solid",type = "l") #L0=0.3
lines(out[,1],out[,28], col="grey30",lwd = 2,lty="solid",type = "l") #L0=0.1
lines(out[,1],out[,28], col="grey0",lwd = 2,lty="solid",type = "l") #L0=0.03
points(x_PDGF,y_PDGF_1,pch=16, type = "p",col="grey70")
points(x_PDGF,y_PDGF_03,pch=16, type = "p", col="grey50")
points(x_PDGF,y_PDGF_01,pch=16, type = "p", col="grey30")
points(x_PDGF,y_PDGF_003,pch=16, type = "p", col="grey0")
legend("topright",ncol=1, legend=c("1 nM","0.3 nM","0.1 nM","0.03 nM"), bty = "n",
       col=c("grey70","grey50","grey30","grey0"), pch=c(16,16,16,16), cex=1)


ky_PDGF <- 0.9
y_AKT_003 <- c(0,0.404,0.53,0.5,0.25,0.13)*ky_PDGF # PDGF0=0.03 nM
y_AKT_01 <- c(0,0.74,0.949,0.963,0.76,0.417)*ky_PDGF # PDGF0=0.1 nM
y_AKT_03 <- c(0,1.016,1.063,0.996,0.835,0.592)*ky_PDGF # PDGF0=0.3 nM
y_AKT_1 <- c(0.114,1.01,1.037,1.023,0.922,0.687)*ky_PDGF # PDGF0=1 nM
plot(out[,1],out[,15]+out[,16]-out[1,15]-out[1,16], lwd = 2,lty="solid",col="grey70",ylab='AKT, a.u.', xlab='time, min',type = "l", ylim=c(0, 1.15)) # L0=1
lines(out[,1],out[,15]+out[,16]-out[1,15]-out[1,16],lwd = 2,lty="solid",col="grey50", type = "l") #L0=0.3
lines(out[,1],out[,15]+out[,16]-out[1,15]-out[1,16], lwd = 2,lty="solid",col="grey30", type = "l") #L0=0.1
lines(out[,1],out[,15]+out[,16]-out[1,15]-out[1,16], lwd = 2,lty="solid",col="grey0", type = "l") #L0=0.03
points(x_PDGF,y_AKT_1,pch=16, type = "p", col="grey70")
points(x_PDGF,y_AKT_03,pch=16, type = "p", col="grey50")
points(x_PDGF,y_AKT_01,pch=16, type = "p", col="grey30")
points(x_PDGF,y_AKT_003,pch=16, type = "p", col="grey0")
legend("top",ncol=4, legend=c("1 nM","0.3 nM","0.1 nM","0.03 nM"), bty = "n",
       col=c("grey70","grey50","grey30","grey0"), pch=c(16,16,16,16))
